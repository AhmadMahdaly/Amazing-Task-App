...
import 'package:s/features/missed_prayers/presentation/views/widgets/prayer_item_widget.dart';
...
class PrayersTrackingView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(AppTexts.trackingTitle, style: AppTextStyle.style16Bold),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                '${AppTexts.completedRatio}: ${(progress * 100).toStringAsFixed(1)}%',
                style: AppTextStyle.style12W500.copyWith(
                  color: AppColors.secondaryColor,
                ),
              ),
              Text(
                '${AppTexts.remainingRatio}: ${((1 - progress) * 100).toStringAsFixed(1)}%',
                style: AppTextStyle.style12W500.copyWith(
                  color: AppColors.secondaryColor,
                ),
              ),
