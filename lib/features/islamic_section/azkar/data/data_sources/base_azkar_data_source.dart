...
import 'package:s/features/islamic_section/azkar/data/models/azkar_category_model.dart';
...
class AzkarLocalDataSourceImpl implements BaseAzkarDataSource {
  ...
  Future<AzkarCategoryModel> getMorningAzkar() async {
    try {
      ...
      throw Exception('حدث خطأ أثناء تحميل أذكار الصباح');
    }
  }
  ...
  Future<AzkarCategoryModel> getEveningAzkar() async {
    try {
      ...
      throw Exception('حدث خطأ أثناء تحميل أذكار المساء');
    }
  }
  ...
  Future<AzkarCategoryModel> getSleepingAzkar() async {
    try {
      ...
      throw Exception('حدث خطأ أثناء تحميل أذكار النوم');
    }
  }
}
